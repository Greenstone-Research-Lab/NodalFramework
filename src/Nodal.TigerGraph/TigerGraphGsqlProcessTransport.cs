...
/// </remarks>
public sealed class TigerGraphGsqlProcessTransport : ITigerGraphAdministrativeTransport
{
    ...
    public async ValueTask ExecuteAsync(MigrationCommand command, CancellationToken cancellationToken = default)
    {
        ...
        startInfo.ArgumentList.Add(command.Text);
        ...
        if (process.ExitCode != 0)
        {
            throw new InvalidOperationException(
                $"GSQL administrative command failed with exit code {process.ExitCode}. " +
